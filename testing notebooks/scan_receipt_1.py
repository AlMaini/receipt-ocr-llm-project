### Only works for receipt example 3
### Probably only works for clear receipt images
...
ap.add_argument("-d", "--debug", type=int, default=0, help="whether or not to show intermediate results")
